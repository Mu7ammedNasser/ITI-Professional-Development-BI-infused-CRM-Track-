...
namespace MVC_Day03_lab.Data.Context
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-DH7T4Q7;DataBase=MVC_DAY03_Lab;Trusted_Connection=true;TrustServerCertificate=true");
