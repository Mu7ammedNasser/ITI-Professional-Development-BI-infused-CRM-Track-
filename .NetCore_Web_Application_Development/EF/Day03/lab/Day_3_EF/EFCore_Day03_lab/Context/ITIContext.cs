...
using EFCore_Day03_lab.Models;
using Microsoft.EntityFrameworkCore;

namespace EFCore_Day03_lab.Context;
...
protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    => optionsBuilder.UseSqlServer("Data Source=DESKTOP-DH7T4Q7;Initial Catalog=ITI;Integrated Security=True;TrustServerCertificate=True;");
